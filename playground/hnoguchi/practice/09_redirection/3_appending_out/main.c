...
/*   Updated: 2023/02/14 12:28:10 by hnoguchi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	t_token *token;
	t_node	*node;
	char	*line = "echo <hello.txt >f1 >>fire.txt";
	// char	*line = "echo hello >f1 >>fire.txt";
	// char	*line = "echo hello >hello.txt >f1";
	// char	*line = "pwd >f1 >>fire.txt";
